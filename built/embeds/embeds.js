...
exports.getAvatarEmbed = exports.getUserEmbed = exports.getServerEmbed = exports.getPingEmbed = exports.getPongEmbed = void 0;
const discord_js_1 = require("discord.js");
const functions_1 = require("../functions/functions");
const getPongEmbed = () => {
    const rand = (0, functions_1.randomIntFromInterval)(1, 6);
    let link;
    switch (rand) {
        case 1:
...
exports.getPongEmbed = getPongEmbed;
const getPingEmbed = () => {
    const rand = (0, functions_1.randomIntFromInterval)(1, 7);
    let link;
    switch (rand) {
        case 1:
...
exports.getPingEmbed = getPingEmbed;
const getServerEmbed = (interaction) => {
...
exports.getServerEmbed = getServerEmbed;
const getUserEmbed = (interaction) => {
    return new discord_js_1.MessageEmbed()
...
exports.getAvatarEmbed = getAvatarEmbed;
