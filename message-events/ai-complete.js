		...
		if (searchIndex != -1 && command.length > 1) {
			...
			if (searchQuery != '') {
				...
				const response = await openai.createCompletion('text-curie-001', {
					prompt: 'generBot is an extremely philosophical chatbot that is somewhat nihilistic and standoffish but responds well to loaded questions with depth and a hint of sarcasm:\n\nYou: ' + searchQuery.join(' ') + '\ngenerBot:',
